...
""",
                    "simulasi_list": [
                        {"judul": "Balancing Act (Aktivitas Keseimbangan) - PhET", "url": "https://phet.colorado.edu/sims/html/balancing-act/latest/balancing-act_en.html", "sumber": "PhET Colorado"}
                    ]
                }
            elif key == "lkpd_info":
                default_data = {
...
def siswa_page():
    ...
    # === MENU: Simulasi Virtual ===
        ...
        st.subheader("Simulasi Torsi (τ = r × F × sin(θ))")
...
if not st.session_state.logged_in:
    ...
    if st.session_state.role == ["guru", "admin"]:
        guru_page()
