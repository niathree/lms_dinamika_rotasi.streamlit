# lms_dinamika_rotasi_final_fix_v2.py
        ...
        if st.session_state.role in ["guru", "admin"]:
            ...
            with st.form("form_edit_simulasi"):
                ...
                if simulasi_list:
                    ...
                    judul_sim_baru = st.text_input(f"Judul Simulasi", value=sim.get("judul", ""), key=f"sim_judul_0")
                    url_sim_baru = st.text_input(f"URL Simulasi", value=sim.get("url", ""), key=f"sim_url_0")
                    sumber_sim_baru = st.text_input(f"Sumber Simulasi", value=sim.get("sumber", ""), key=f"sim_sumber_0")
