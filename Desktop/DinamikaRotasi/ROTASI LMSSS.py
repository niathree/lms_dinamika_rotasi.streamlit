...
def pre_test():
    ...
    JAWABAN_FILE = os.path.join(os.path.dirname(FILES["hasil_nilai"]), "pre_test_jawaban.csv")
    os.makedirs(os.path.dirname(JAWABAN_FILE), exist_ok=True)
...
def post_test():
    ...
    JAWABAN_FILE = os.path.join(os.path.dirname(FILES["hasil_nilai"]), "post_test_jawaban.csv")
    os.makedirs(os.path.dirname(JAWABAN_FILE), exist_ok=True)
